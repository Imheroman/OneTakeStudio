...
export type NavItem = { label: string; href: string } | (NavDropdownItem & { dropdown: true });
...
function isDropdown(item: NavItem): item is NavDropdownItem & { dropdown: true } {
...
export function Navbar({
  ...
  const base =
    variant === "glass"
      ...
      : variant === "dark"
        ? "h-16 flex items-center justify-between px-8 bg-black/80 backdrop-blur-md sticky top-0 z-50 border-b border-white/10"
