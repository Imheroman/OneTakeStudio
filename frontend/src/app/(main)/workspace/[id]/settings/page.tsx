  ...
  [
    {
      value: "high",
      label: "고사양",
      desc: "풀 애니메이션·효과 (권장: 고사양 PC)",
    },
    { value: "medium", label: "보통", desc: "일부 효과만 축소" },
    {
      value: "low",
      label: "저사양",
      desc: "애니메이션 최소화 (저사양·저전력 기기)",
    },
  ];
...
export default function WorkspaceSettingsPage({
  ...
  const setPerformanceTier = useWorkspaceDisplayStore(
    (s) => s.setPerformanceTier
  );
        ...
        <TabsContent value="spec" className="space-y-6">
          <Card className={cn(isDark ? "bg-gray-900/50 border-gray-700" : "")}>
            <CardHeader>
              ...
              <CardDescription>
                고사양: 풀 애니메이션. 저사양: 애니메이션 최소화로 저사양
                기기에서도 부드럽게.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
