...
public class PublishEventPublisher {
     ...
     * 송출 시작 이벤트
     */
    public void publishStarted(String studioId, String publishSessionId) {
     ...
     * 송출 종료 이벤트 (정상 종료)
     */
    public void publishStopped(String studioId, String publishSessionId) {
     ...
     * 송출 실패 이벤트 (에러 발생)
     */
    public void publishFailed(String studioId, String publishSessionId, String errorMessage) {
     ...
     */
    public void publishEndedExternally(String studioId, String publishSessionId, String reason) {
        sendEvent(studioId, PublishEventType.PUBLISH_ENDED_EXTERNALLY, publishSessionId, reason);
    }

    private void sendEvent(String studioId, PublishEventType eventType, String publishSessionId, String message) {
